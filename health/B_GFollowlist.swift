...
//  health
//
//  Created by Songjeongpyeong on 2021/09/07.
//

import Foundation
import UIKit

class B_GFollowlist: UIButton {
    
    var isActivated : Bool = false
    
    let activatedImage = UIImage(systemName: "checkmark.square")?.withTintColor(#colorLiteral(red: 0.2483623028, green: 0.5312670469, blue: 0.9978526235, alpha: 1)).withRenderingMode(.alwaysOriginal)
    let normalImage = UIImage(systemName: "checkmark.square")?.withTintColor(#colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1)).withRenderingMode(.alwaysOriginal)
