...
class GM_follow_o{
    ...
    var delegate: GM_Follow_oProtocol!
    var urlPath = "\(Share.urlIP)GM_followlist.jsp"
   
    func GM_Follow_odownItems(user_u_no: Int, check: Int, searchTexts: String){
    ...
    func parseJSON(_ data: Data) {
        ...
        DispatchQueue.main.async(execute: {() -> Void in
           ...
           var g_count = 0
            ...
            self.delegate.GM_Follow_oitemDownloaded(follow_o_items: locations, g_list_cout: g_count)
